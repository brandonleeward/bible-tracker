...
export default function Goals() {
  const { goalType, goalPace, goalDate, setSetting, isLoading: settingsLoading } = useAppSettings();
        ...
        {goalType === 'pace' && (
          <div>
            ...
            <p style={{ marginTop: '12px', fontSize: '0.9rem', color: 'var(--text, #666)' }}>
              At this pace, you'll finish the remaining {chaptersRemaining} chapters in about {Math.ceil(chaptersRemaining / goalPace)} days.
            </p>
          </div>
        )}
